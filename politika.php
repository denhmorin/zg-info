...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
		...
		<div class="body">
			...
			$upit=mysqli_query($veza, "select * FROM vijest WHERE vrsta_id = 1 ORDER BY datum DESC") or die(mysql_error());
			  ...
			  echo "<div class='row'>";
				if (!empty($red["slika"])){
					...
					<div class='col-md-4 col-sm-4 col-xs-12'>
						...
						<a href='vijest-politika.php?vijest_id=".$red["vijest_id"]."'><img src='".$red["slika"]."' alt='".$red["naziv"]."' class='img-responsive slika-vijesti' />
							<div class='overlay'>
				...
				echo "<div class='okvir-novosti fadeInRight'>
							...
							<h2 class=''><a href='vijest-politika.php?vijest_id=".$red["vijest_id"]."'>".$red["naziv"]." <span class='crta'>/</span> <span class='tekst'>".$red["kratki_tekst"]."</span></a></h2>";
							if (isset($_SESSION["tip_id"]) AND $_SESSION["tip_id"] == 0){
